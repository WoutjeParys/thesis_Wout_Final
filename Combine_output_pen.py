...
#   A series of DR PENETRATION RATES is considered in each excel file
#   An excel file can be made for different renewable targets
#
#   => each excel file compares a series of DR penetration rates for one specific renewable target
#   .gdx files of different cases need to be gathered in one map and are named: out_db_'target'_DRpen_'DR-penetration-rate'.gdx
#
...
#renewable target
target = 70
#list with considered DR penetration rates
